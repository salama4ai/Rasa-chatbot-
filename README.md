...
+ **Note**:- now the chatbot have an issue just because the endpoint that was provided by master-linux firm is not valid anymore, please replace the existing endpoint with another working one, and the model will works again
